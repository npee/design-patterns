...
public class ThreadSafeChocolateBoilerV3 extends Thread {

	private boolean empty;
	private boolean boiled;

	private static class LazyHolder {
		private static final ThreadSafeChocolateBoilerV3 uniqueInstance = new ThreadSafeChocolateBoilerV3();
	}

	private ThreadSafeChocolateBoilerV3() {
		this.empty = true;
		this.boiled = false;
	}

	public static ThreadSafeChocolateBoilerV3 getInstance() {
